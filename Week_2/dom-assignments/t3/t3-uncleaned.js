function Main(){
    ...
    //console log tests
    console.log(getBrowserName(navigator.userAgent));
    console.log(getSystemOS(navigator.userAgentData));
    console.log(getTotalScreenWidth());
    console.log(getTotalScreenHeight());

    console.log(getScreenWidthNoWin());
    console.log(getScreenHeightNoWin());
